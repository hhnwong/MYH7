...
echo "Running WEKA..."
java $CLASSIFIER $WEKAOPTS  -t n1.arff >n1.out
java $CLASSIFIER $WEKAOPTS  -t n2.arff >n2.out
java $CLASSIFIER $WEKAOPTS  -t n3.arff >n3.out
java $CLASSIFIER $WEKAOPTS  -t n4.arff >n4.out
java $CLASSIFIER $WEKAOPTS  -t n5.arff >n5.out
java $CLASSIFIER $WEKAOPTS  -t n6.arff >n6.out
java $CLASSIFIER $WEKAOPTS  -t n7.arff >n7.out
java $CLASSIFIER $WEKAOPTS  -t n8.arff >n8.out
java $CLASSIFIER $WEKAOPTS  -t n9.arff >n9.out
java $CLASSIFIER $WEKAOPTS  -t n10.arff >n10.out
